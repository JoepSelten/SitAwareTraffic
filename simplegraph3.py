...
intersection_road_current = add_has_a(g, EX.intersection, EX.road_current)
...
g.add((intersection_road_current, RDF.type, EX.road))
...
g.add((intersection_middle, EX.connects, intersection_road_current))
