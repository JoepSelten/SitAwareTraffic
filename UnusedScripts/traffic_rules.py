...
class ApproachingCrossing():
    ...
    def init_rules(self, world):
        ...
        self.rule1.object = URIRef("http://example.com/intersection/crossing")
        ...
        self.rule3.object = URIRef("http://example.com/intersection/crossing")
        ...
        self.rule4.object = URIRef("http://example.com/intersection/crossing")
